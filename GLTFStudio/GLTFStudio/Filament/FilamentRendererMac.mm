...
@interface FilamentRendererMac () <MTKViewDelegate>
...
@implementation FilamentRendererMac
...
- (void)setupAppearance {
    self.backgroundColor = [NSColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:1.0f];
...
- (void)applyBackgroundColor {
    ...
    self.backgroundColor = [NSColor colorWithRed:red green:green blue:blue alpha:alpha];
}
